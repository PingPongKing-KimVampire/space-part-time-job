...
const SearchNeighborPage = () => {
  ...
  const [displayedNeighbors, setDisplayedNeighbors] = useState<Neighbor[]>([]);
  ...
  const searchResultElements = useMemo(() => {
    return displayedNeighbors.map((neighbor) => {
  ...
  }, [displayedNeighbors, selectedNeighbors, onNeighborClick]);
